...
For a single item order, just list the item name by itself with no prefix. \
If a quantity is mentioned and greater than 1, put it in parentheses at the end.
For example: "Barrel of Maple Syrup" or "Protein Bars (12)"

For multiple items, list them with a comma-separated format, \
with quantities in parentheses at the end of each item:
...
For a single item order, just list the item name by itself with no numbering. \
If a quantity is mentioned and greater than 1, put it in parentheses at the end.
For example: "Barrel of Maple Syrup" or "Protein Bars (12)"
